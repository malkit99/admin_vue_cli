                ...
                <ValidationObserver ref="courseForm" v-slot="{ passes}">
                            <b-form  @submit.prevent="passes(saveCourse)" @reset="resetForm" >
                                <div class="container">
                                    ...
                                    <b-card v-if="standardsSubjects.length > 0" class="p-2 border border-primary text-primary"  title="Select Subjects" id="nav-scroller" ref="content" style="position:relative; height:200px; overflow-y:scroll;">
                                        <b-card-body >
                                            <div class="row">
